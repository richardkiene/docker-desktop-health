...
```shell
  docker buildx build -t richardkiene/docker-desktop-health:latest . --load
```

To install the extension, use `make install-extension` **or**:

```shell
  docker extension install richardkiene/docker-desktop-health:latest
```
...
```shell
  docker extension dev ui-source richardkiene/docker-desktop-health:latest http://localhost:3000
```

In order to open the Chrome Dev Tools for your extension when you click on the extension tab, run:

```shell
  docker extension dev debug richardkiene/docker-desktop-health:latest
```

Each subsequent click on the extension tab will also open Chrome Dev Tools. To stop this behaviour, run:

```shell
  docker extension dev reset richardkiene/docker-desktop-health:latest
```
...
```shell
docker extension update richardkiene/docker-desktop-health:latest
```
...
```shell
docker extension rm richardkiene/docker-desktop-health:latest
```
